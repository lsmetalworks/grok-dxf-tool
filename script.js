// Parts library with corrected DXF for holed plate
const partsLibrary = {
    gear: {
        name: "Gear",
    ...
    holedPlate: {
        ...
        draw: (ctx, width, height, holeSize, holeInset, cornerRadius) => {
            ...
            ctx.arc(width - r, r, r, -Math.PI / 2, 0); // Top-right
            ctx.lineTo(width, height - r);
            ctx.arc(width - r, height - r, r, 0, Math.PI / 2); // Bottom-right
            ctx.lineTo(r, height);
            ctx.arc(r, height - r, r, Math.PI / 2, Math.PI); // Bottom-left
            ctx.lineTo(0, r);
            ctx.arc(r, r, r, Math.PI, -Math.PI / 2); // Top-left
            ctx.closePath();
            ctx.fillStyle = "#666";
            ctx.fill();
        ...
        toDXF: (width, height, holeSize, holeInset, cornerRadius) => {
            ...
            if (cornerRadius > 0) {
                ...
                dxf.push("0", "VERTEX", "8", "0", "10", (width - cornerRadius).toString(), "20", cornerRadius.toString());
                ...
                dxf.push("0", "VERTEX", "8", "0", "10", (width - cornerRadius).toString(), "20", (height - cornerRadius).toString());
                ...
                dxf.push("0", "VERTEX", "8", "0", "10", cornerRadius.toString(), "20", (height - cornerRadius).toString());
...
function previewPart() {
    ...
    if (!width || !height || (partType === "Holed Mounting Plate" && (!holeSize || !holeInset || isNaN(cornerRadius)))) {
